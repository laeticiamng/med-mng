-- Seed baseline integrity checks and snapshot for staging
...
values
    ('staging', 'database_migrations_applied', 'pass', '{"notes":"staging baseline"}'::jsonb, '2024-01-01T00:00:00+00'),
    ('staging', 'rls_policies_enforced', 'pass', '{"notes":"staging baseline"}'::jsonb, '2024-01-01T00:00:00+00'),
    ('staging', 'analytics_pipeline_healthy', 'warn', '{"notes":"staging analytics uses sandbox endpoints"}'::jsonb, '2024-01-01T00:00:00+00');
