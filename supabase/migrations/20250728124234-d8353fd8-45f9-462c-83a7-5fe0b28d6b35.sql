-- DIAGNOSTIC ET CORRECTION DU PROBLÈME RLS/USER_ID

-- 1. Diagnostic des policies actuelles
SELECT 
    schemaname,
    tablename, 
    policyname, 
    ...
    qual
FROM pg_policies 
WHERE tablename = 'generated_music_tracks';

-- 2. Vérifier les tracks avec user_id anonyme
SELECT 
...
-- 3. CORRECTION: Supprimer les policies restrictives
...
-- 4. Créer des policies permissives pour le développement
...
-- 5. Normaliser les user_id existants
UPDATE generated_music_tracks 
SET user_id = '00000000-0000-0000-0000-000000000000'
WHERE user_id IS NULL OR user_id = '';

-- 6. Fonction helper pour debug (sécurisée)
