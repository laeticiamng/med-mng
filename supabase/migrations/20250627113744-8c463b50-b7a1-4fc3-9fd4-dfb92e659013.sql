...
-- Vérifier et corriger l'affichage de l'item IC-2
-- D'abord, supprimer les doublons potentiels en gardant le premier créé
...
-- Ensuite, s'assurer que l'item IC-2 existe avec les bonnes données
