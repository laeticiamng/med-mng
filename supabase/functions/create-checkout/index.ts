...
const PLANS = {
  standard: {
    price_id: "price_1RqGSeDFa5Y9NR1IbOwa1TGy",
    product_id: "plan_standard",
    name: "Standard",
    amount: 1900, // 19€
  },
  pro: {
    price_id: "price_1RqGT0DFa5Y9NR1IegoELBi8", 
    product_id: "plan_pro",
    name: "Pro",
    amount: 2900, // 29€
  },
  premium: {
    price_id: "price_1RqGTHDFa5Y9NR1IcGxsiIP8",
...
serve(async (req) => {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: "subscription",
      success_url: `${req.headers.get("origin")}/med-mng/subscription-success?session_id={CHECKOUT_SESSION_ID}`,
