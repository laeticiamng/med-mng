/**
 * Schémas Supabase Manquants
 * À exécuter pour compléter la base de données
 *
...
CREATE TABLE IF NOT EXISTS public.user_favorites (
  ...
  CONSTRAINT valid_item_type CHECK (item_type IN ('edn', 'ecos', 'song', 'product')),
...
4. Tester les politiques RLS avec différents utilisateurs

5. Ajouter les références dans le code TypeScript:
   - Types dans src/types/database.ts
   - Queries dans src/services/
   - Hooks dans src/hooks/

6. Créer des migrations Supabase pour la gestion des versions
