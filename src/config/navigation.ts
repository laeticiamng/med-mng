...
export const LEGAL_PAGES: NavItem[] = [
  ...
  { path: ROUTE_PATHS.cgv, label: 'CGV', icon: FileText },
  { path: ROUTE_PATHS.cookies, label: 'Cookies', icon: FileText },
...
export const ALL_ACCESSIBLE_PAGES = [
  ...
  { path: ROUTE_PATHS.cgv, label: 'CGV', category: 'Légal' },
  { path: ROUTE_PATHS.cookies, label: 'Cookies', category: 'Légal' },
