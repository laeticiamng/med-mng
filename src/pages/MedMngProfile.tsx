      ...
      <ConsistentBackground variant="light">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <PageHeader
            ...
            icon={User}
            badge={{
              text: profile?.subscription_plan === 'premium' ? 'Premium' : profile?.subscription_plan === 'pro' ? 'Pro' : 'Gratuit',
              variant: profile?.subscription_plan === 'premium' || profile?.subscription_plan === 'pro' ? 'default' : 'secondary'
            }}
          />
