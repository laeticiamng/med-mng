    ...
    <ConsistentBackground variant="primary">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
            ...
            <div className="min-w-0 flex-1">
              <h1 className="text-lg sm:text-2xl font-bold text-foreground truncate">MED MNG</h1>
              <p className="text-xs sm:text-sm text-muted-foreground hidden sm:block">Plateforme d'apprentissage médical avec IA musicale</p>
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            <Button 
              variant="ghost" 
              size="sm"
              className="text-muted-foreground hover:text-foreground hover:bg-secondary/20 hidden sm:flex"
            ...
            <Button 
              size="sm"
              className="bg-secondary/20 backdrop-blur-sm text-foreground border border-border hover:bg-secondary/30 text-xs sm:text-sm"
      ...
      <div className="container mx-auto px-4 py-8 sm:py-12">
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="lcp-heading text-4xl sm:text-6xl md:text-8xl font-bold text-foreground mb-6 sm:mb-8 leading-tight" id="main-content">
            Apprenez la médecine<br />
            <span className="bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent">
              comme jamais
            </span>
          </h2>
          <p className="text-base sm:text-xl text-muted-foreground mb-8 sm:mb-10 max-w-3xl mx-auto leading-relaxed px-2">
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-6 px-4">
            <div className="flex items-center gap-2 bg-secondary/20 backdrop-blur-sm px-3 sm:px-4 py-2 rounded-full border border-border">
              <Zap className="w-3 h-3 sm:w-4 sm:h-4 text-pink-400" />
              <span className="text-foreground text-xs sm:text-sm font-medium">IA Avancée</span>
            </div>
            <div className="flex items-center gap-2 bg-secondary/20 backdrop-blur-sm px-3 sm:px-4 py-2 rounded-full border border-border">
              <Shield className="w-3 h-3 sm:w-4 sm:h-4 text-purple-400" />
              <span className="text-foreground text-xs sm:text-sm font-medium">367 Items EDN</span>
            </div>
            <div className="flex items-center gap-2 bg-secondary/20 backdrop-blur-sm px-3 sm:px-4 py-2 rounded-full border border-border">
              <Award className="w-3 h-3 sm:w-4 sm:h-4 text-blue-400" />
              <span className="text-foreground text-xs sm:text-sm font-medium">Certifié Médical</span>
            </div>
          </div>
        </div>
            ...
            <div className="bg-card/80 backdrop-blur-sm border border-border rounded-full px-6 py-3">
              <div className="flex items-center space-x-4 text-foreground">
                ...
                <div className="text-center">
                  ...
                  <div className="text-xs text-muted-foreground">Étudiants actifs</div>
                </div>
                <div className="w-px h-8 bg-border"></div>
                <div className="text-center">
