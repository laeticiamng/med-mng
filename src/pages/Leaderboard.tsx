      ...
      <div className="container max-w-4xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Comp�tez avec les autres membres de la communaut�
          </p>
        </div>
                ...
                {currentLeaderboard.length === 0 ? (
                  <div className="text-center py-12">
                    {overallLoading || weeklyLoading || monthlyLoading ? (
                      ...
                      <p className="text-muted-foreground">Aucune donn�e de classement disponible</p>
                    )}
                  </div>
                ) : (
                  <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>" Cr�er un post: 10 points</li>
                  <li>" �crire un commentaire: 5 points</li>
                  <li>" Obtenir un badge: 50 points</li>
                  <li>" Compl�ter un objectif: 100 points</li>
                  <li>" Maintenir une s�rie: 25 points par jour</li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  ...
                  <li>" Votre aura change � chaque niveau</li>
