...
import { TrendingChart } from "@/components/quality/TrendingChart";
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <Tabs defaultValue="current" className="w-full">
        <TabsList>
          <TabsTrigger value="current">Vue actuelle</TabsTrigger>
        ...
        <TabsContent value="trending" className="space-y-6">
          <TrendingChart period="7d" />
          <TrendingChart period="30d" />
          <TrendingChart period="90d" />
        </TabsContent>
      </Tabs>
    </div>
  );
