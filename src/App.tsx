...
const EdnDebug = lazy(() => import("./pages/EdnDebug"));
...
const QualityAdminPage = lazy(() => import("./pages/QualityAdminPage"));
    ...
    <ThemeProvider defaultTheme="system" storageKey="med-mng-ui-theme">
      <QueryClientProvider client={queryClient}>
        ...
        <Route path={ROUTE_PATHS.modularDashboard} element={<Suspense fallback={<div className="flex items-center justify-center p-8"><div className="animate-spin rounded-full h-8 w-8 border-b-2 border-primary"></div></div>}><ModularDashboard /></Suspense>} />
          ...
          <Route path="/edn-debug" element={<Suspense fallback={<div className="flex items-center justify-center p-8"><div className="animate-spin rounded-full h-8 w-8 border-b-2 border-primary"></div></div>}><EdnDebug /></Suspense>} />
          ...
          <Route path="/quality-admin" element={<Suspense fallback={<div className="flex items-center justify-center p-8"><div className="animate-spin rounded-full h-8 w-8 border-b-2 border-primary"></div></div>}><QualityAdminPage /></Suspense>} />
