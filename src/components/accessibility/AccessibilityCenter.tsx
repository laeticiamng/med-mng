...
export const AccessibilityCenter: React.FC = () => {
  ...
  const handleFocusVisibleChange = useCallback((enabled: boolean) => {
    ...
    setLocalSettings(prev => ({ ...prev, focusVisible: enabled }));
  }, [accessibility]);
  ...
  const AccessibilityQuickActions = () => (
    <div className="grid grid-cols-2 gap-4">
      <Button
        variant={localSettings.highContrast ? "default" : "outline"}
        onClick={() => handleHighContrastChange(!localSettings.highContrast)}
      ...
      <Button
        variant={localSettings.reducedMotion ? "default" : "outline"}
        onClick={() => handleReducedMotionChange(!localSettings.reducedMotion)}
        className="h-auto p-4 flex flex-col items-center space-y-2"
      >
      ...
      <Button
        variant={localSettings.focusVisible ? "default" : "outline"}
        onClick={() => handleFocusVisibleChange(!localSettings.focusVisible)}
        className="h-auto p-4 flex flex-col items-center space-y-2"
      >
    ...
    <div className="space-y-6">
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch
            id="color-blind"
            checked={localSettings.colorBlindAssist}
            onCheckedChange={(enabled) => 
              setLocalSettings(prev => ({ ...prev, colorBlindAssist: enabled }))
            }
          />
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Slider
            value={[localSettings.magnification]}
            onValueChange={([value]) => 
              setLocalSettings(prev => ({ ...prev, magnification: value }))
            }
            min={75}
            max={200}
            step={25}
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch
            ...
            onCheckedChange={(enabled) => 
              setLocalSettings(prev => ({ ...prev, keyboardNavigation: enabled }))
            }
          />
        </div>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch
            ...
            onCheckedChange={(enabled) => 
              setLocalSettings(prev => ({ ...prev, screenReaderMode: enabled }))
            }
          />
        </div>
