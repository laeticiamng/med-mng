          ...
          <CardHeader className={`${themeColors.bg} cursor-pointer hover:${themeColors.accent} transition-colors`}>
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                {competence.sommaire && <Eye className="w-4 h-4 text-green-600" />}
                {competence.mecanismes && <Settings className="w-4 h-4 text-blue-600" />}
                {competence.indications && <Target className="w-4 h-4 text-orange-600" />}
                {competence.effets_indesirables && <AlertTriangle className="w-4 h-4 text-red-600" />}
          ...
          <CardContent className="pt-4">
            ...
            <Tabs defaultValue="details" className="w-full">
              ...
              <TabsContent value="meta" className="space-y-3 mt-4">
                ...
                {competence.keywords && competence.keywords.length > 0 && (
                  <div className="p-3 bg-gray-50 border border-gray-200 rounded-lg">
                    <h4 className="font-semibold text-gray-800 text-sm mb-2">Mots-clés</h4>
                    <div className="flex flex-wrap gap-1">
                      {competence.keywords.map((keyword, idx) => (
