...
/**
 * 🎯 DONNÉES SPÉCIFIQUES ITEM IC-1 - MED-MNG v3.0
 * Basé sur la fiche E-LiSA officielle - 15 connaissances exactement (toutes Rang A)
 */

import type { ColonneConfig } from '@/types';
...
export const colonnesConfigIC1: ColonneConfig[] = [
  { id: 'concept', label: 'Connaissance Fondamentale', width: 200 },
  { id: 'definition', label: 'Définition Officielle E-LiSA', width: 300 },
  { id: 'exemple', label: 'Exemple Concret Précis', width: 250 },
  { id: 'piege', label: 'Piège Fréquent À Éviter', width: 200 },
  { id: 'mnemo', label: 'Moyen Mnémotechnique', width: 180 },
  { id: 'subtilite', label: 'Subtilité Importante', width: 200 },
  { id: 'application', label: 'Application Pratique', width: 200 },
  { id: 'vigilance', label: 'Point de Vigilance', width: 200 }
];
