...
export const SceneCentralArea = ({ 
  ...
  return (
    <div className={`relative bg-gradient-to-br ${theme.secondary} rounded-3xl mx-8 p-20 min-h-[700px] flex items-center justify-center ${theme.glowColor} shadow-2xl border-4 border-background/40`}>{/* Removed overflow-hidden */}
