...
const features = [
  {
    ...
    subtitle: 'Ton cerveau fait le travail',
  ...
  },
  {
    ...
    icon: Brain,
    title: 'Mémoire x3',
    subtitle: 'Prouvé par la science',
...
export const AppleFeatureShowcase = () => {
  ...
  return (
    <section ref={sectionRef} className="relative py-20 lg:py-28 overflow-hidden">
      {/* Background - subtly different from other sections */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto">
            Ce n'est pas une promesse. C'est de la neuroscience appliquée.
          </p>
        </motion.div>
        ...
        >
          <div className="inline-flex flex-col sm:flex-row gap-4">
            <Button
              ...
              className="h-14 px-8 text-lg font-semibold rounded-2xl bg-gradient-to-r from-primary to-accent hover:opacity-90 shadow-lg transition-all hover:scale-105"
            >
              <BookOpen className="h-5 w-5 mr-2" />
              Explorer les 367 items
            </Button>
            <Button
              variant="outline"
              size="lg"
              onClick={() => navigate(ROUTE_PATHS.ecosIndex)}
              className="h-14 px-8 text-lg font-semibold rounded-2xl border-2 transition-all hover:scale-105"
            >
