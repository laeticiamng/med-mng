      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div initial={{ opacity: 0, y: 40 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.8, delay: 0.6 }} className="text-center">
          <div className="inline-flex flex-col sm:flex-row gap-4">
            <Button size="lg" onClick={() => navigate(ROUTE_PATHS.ednComplete)} className="h-14 px-8 text-lg font-semibold rounded-2xl bg-gradient-to-r from-primary to-accent hover:opacity-90 shadow-lg glow-pulse transition-all hover:scale-105">
