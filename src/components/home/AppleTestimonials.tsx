      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto">
            <TranslatedText text="Retours de nos premiers utilisateurs. Sceptiques au d\u00e9but. Convaincus maintenant." />
          </p>
        </motion.div>
            ...
            >
              <div className="relative h-full bg-card/60 backdrop-blur-xl border border-border/30 rounded-3xl p-8 transition-all duration-500 hover:border-primary/30 hover:shadow-xl hover:shadow-primary/5">
                ...
                <div className="flex items-center gap-4">
                  <div
                    className={`w-12 h-12 rounded-full bg-gradient-to-br ${testimonial.avatarGradient} flex items-center justify-center text-primary-foreground font-bold`}
                  >
                    {testimonial.avatar}
                  </div>
                  <div>
        ...
        >
          ...
          <p className="text-sm text-muted-foreground mt-3">
            <TranslatedText text="Gratuit pour commencer \u00b7 Sans engagement" />
          </p>
        </motion.div>
        ...
        >
          {stats.map((stat, index) => (
            ...
            >
              <p className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent mb-2">
                {stat.value}
              </p>
