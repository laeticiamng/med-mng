...
export type LogContext = 'app' | 'api' | 'auth' | 'music' | 'ui' | 'performance' | 'security' | 'database' | 'cache' | 'validation' | 'pwa' | 'testing' | 'accessibility' | 'i18n' | 'audio' | 'analytics' | 'audit' | 'error-boundary' | 'keyboard';
