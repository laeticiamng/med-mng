...
export default function SearchSaved() {
  return (
    <>
      <Helmet><title>Recherches Sauvegardées | Med-Mng</title></Helmet>
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8"><h1 className="text-4xl font-bold text-gray-900 mb-4">Recherches Sauvegardées</h1>
