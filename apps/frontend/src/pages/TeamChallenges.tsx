...
export default function TeamChallenges() {
  return (
    <>
      <Helmet><title>Challenges d'Équipe | Med-Mng</title></Helmet>
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8"><h1 className="text-4xl font-bold text-gray-900 mb-4">Challenges d'Équipe</h1>
