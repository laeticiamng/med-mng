...
serve(async (req) => {
  ...
  try {
    // ✅ SÉCURITÉ CRITIQUE: Authentification requise pour extract-ecos-uness
    ...
    // ✅ SÉCURITÉ: Vérifier rôle ADMIN pour extract-ecos-uness
    ...
    console.log(`✅ extract-ecos-uness autorisé pour admin ${user.id}`);
