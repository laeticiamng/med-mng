...
Deno.serve(async (req) => {
  ...
  try {
    // ✅ SÉCURITÉ CRITIQUE: Authentification requise pour check-performance-degradation
    ...
    // ✅ SÉCURITÉ: Vérifier rôle ADMIN pour check-performance-degradation
    ...
    console.log(`✅ check-performance-degradation autorisé pour admin ${user.id}`);
