...
Deno.serve(async (req) => {
  ...
  try {
    // ✅ SÉCURITÉ CRITIQUE: Authentification requise pour data-integrity-check
    ...
    // ✅ SÉCURITÉ: Vérifier rôle ADMIN pour data-integrity-check
    ...
    console.log(`✅ data-integrity-check autorisé pour admin ${user.id}`);
