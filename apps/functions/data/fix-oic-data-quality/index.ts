...
serve(async (req) => {
  ...
  try {
    // ✅ SÉCURITÉ CRITIQUE: Authentification requise pour fix-oic-data-quality
    ...
    // ✅ SÉCURITÉ: Vérifier rôle ADMIN pour fix-oic-data-quality
    ...
    console.log(`✅ fix-oic-data-quality autorisé pour admin ${user.id}`);
