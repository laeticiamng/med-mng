...
serve(async (req) => {
  ...
  try {
    // ✅ SÉCURITÉ CRITIQUE: Authentification requise pour update-edn-unique-content
    ...
    // ✅ SÉCURITÉ: Vérifier rôle ADMIN pour update-edn-unique-content
    ...
    console.log(`✅ update-edn-unique-content autorisé pour admin ${user.id}`);
